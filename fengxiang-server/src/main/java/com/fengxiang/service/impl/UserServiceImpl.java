...
import com.fengxiang.exception.LoginFailedException;
import com.fengxiang.mapper.UserMapper;
import com.fengxiang.properties.WeChatProperties;
import com.fengxiang.service.UserService;
import com.fengxiang.utils.HttpClientUtil;
...
public class UserServiceImpl implements UserService {
    ...
    public User wxLogin(UserLoginDTO userLoginDTO) {
        ...
        log.info("准备调用微信登录接口，参数：appid={}, js_code={}, grant_type={}",
                weChatProperties.getAppid(), userLoginDTO.getCode(), "authorization_code");
