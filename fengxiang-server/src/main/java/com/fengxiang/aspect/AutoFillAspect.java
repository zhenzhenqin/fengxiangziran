package com.fengxiang.aspect;

import com.fengxiang.annotation.AutoFill;
import com.fengxiang.constant.AutoFillConstant;
...
/**
 * 自定义切面，用于实现功能自动填充  填充插入以及更新时候的公共字段 创建时间以及更新时间 创建人以及更新人
 */
@Aspect
@Component
@Slf4j
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.fengxiang.mapper.*.*(..)) && @annotation(com.fengxiang.annotation.AutoFill)")
